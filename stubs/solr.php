...
class SolrInputDocument   
{
    ...
    public function addField($fieldName, $fieldValue, $fieldBoostValue=0) {}
    ...
    public function sort(int $sortOrderBy, $sortDirection=SolrInputDocument::SORT_ASC) {}
...
class SolrClient   
{
     ...
     * @return SolrUpdateResponse
     */
    public function  addDocuments(array &$docs, $allowDups=false, $commitWithin=0) {}
...
class SolrQuery extends SolrModifiableParams implements Serializable {
     ...
     * @return SolrQuery
     */
    public function  setHighlightRegexMaxAnalyzedChars($maxAnalyzedChars=null) {}
